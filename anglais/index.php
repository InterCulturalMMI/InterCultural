...
$nom_pays = 'SELECT pays.nom_pays_en, pays.id_pays, UPPER(pays.nom_monument_principal_en), image.url_en FROM image, pays, edition, pays_edition WHERE edition.id_edition = 1 AND (edition.id_edition = pays_edition.id_edition AND pays_edition.id_pays = pays.id_pays) AND pays.id_image_drap = image.id_image';
...
<html lang="fr">
	...
	<body>
		...
		<div class="imgFond">
			<div class="texteBannière">
				<h1>INTERCULTURAL AN EVENT THAT WILL MAKE YOU TRAVEL</h1>
			</div>
			<div class="edition">
				<p class="bold">
					EDITION
					<?php echo $tab_annee[0];?>
					&nbsp;
				</p>
				<p class="fin">
					- LE PUY EN VELAY
		...
		<div class="containerCestQuoi">
			<div class="cestQuoi">
				...
				<div class="cestQuoiParagraph">
					...
					<br>
					<p>
						<strong>INTERCULTURAL</strong>
						 is a unique exhibition. Every 
						<strong>5 years</strong>
						 we invite you to discover the culture of 
						<strong>5 countries</strong>
						 through areas distributed in 
						<strong>the city of Puy en Velay in France</strong>
						.
						<br>
						On each zone you will be immersed in the universe of a country recreated from scratch. You will mainly be able to observe 
						<strong>a reduced-size reconstruction of a monument.</strong>
					</p>
				</div>
			</div>
		</div>
		<div class="expo">
			<img src="../img/fleche_gauche.webp" alt="Decorative arrows">
			</img>
			<h2><strong>DISCOVER EXPOSITIONS</strong></h2>
			<img src="../img/fleche_droite.webp" alt="Decorative arrows">
			</img>
		</div>
		<div class="containerCarrousel">
			...
			<div class="swiper mySwiper">
				<div class="swiper-wrapper">
					<?php for ($i = 0; $i < $nbr_pays; $i++){?>
						<div class="swiper-slide">
							<div class="containerSlide">
								<div class="containerImg">
									<img src="<?php echo $tab_car[$i]['url_en'];?>" alt="Carrousel images">
									</img>
								</div>
								<div class="containerBarrePays">
									<div class="containerDrapeauText">
										<div class="drapeauPays">
											<img src="<?php echo $tab_pays[$i]['url_en'];?>" alt="Flag">
											</img>
										</div>
										<div class="textePays">
											<p>
												<strong><?php echo $tab_pays[$i]['nom_pays_en'];?></strong>
												- 
												<?php echo $tab_pays[$i]['UPPER(pays.nom_monument_principal_en)'];?>
											</p>
										</div>
									</div>
									<div class="containerBouton">
										<div class="bouton">
											<a href="pays.php?id=<?php echo $tab_pays[$i]['id_pays'] ;?>"><p class="bold">DISCOVER</p></a>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="containerAlea">
			<div class="alea">
				<div class="textAlea">
					<p>
						IF YOU <strong>CAN'T MAKE YOUR CHOICE</strong>
					</p>
				</div>
				<div class="boutonAlea">
					...
					<div class="iconAlea">
						...
						<a href="pays.php?id=<?php echo $tab_nav[rand(0, $nbr_element_nav)]['id_pays'] ;?>"><img src="../img/aleatoire.webp" alt="Random choice"></img></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="ou">
				...
				<div class="ouParagraph">
					...
					<p>
						<strong>INTERCULTURAL</strong>
						 takes place 
						<strong>in the town of Le Puy en Velay</strong>
						 in Auvergne, France. A city known for its manufacture of 
						<strong>lace</strong>
						 from Le Puy, the cultivation of 
						<strong>green lentils</strong>
						 from Le Puy and the production of 
						<strong>verbena</strong>
						 from Le Velay. It is also known for being the start of the 
						<strong>Via Podiensis, one of the four French Compostela routes.</strong>
					</p>
				</div>
			</div>
		</div>
