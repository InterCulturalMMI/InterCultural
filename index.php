	...
	<body>
		...
		<div class="imgFond">
			<div class="texteBannière">
				<h1>INTERCULTURAL UN ÉVENEMENT QUI VA VOUS FAIRE VOYAGER</h1>
			</div>
			<div class="edition">
				<p class="bold">
					EDITION
				...
				<div class="cestQuoiParagraph">
					...
					<p>
						<strong>INTERCULTURAL</strong>
						 est une exposition inédite. Tout les 
						<strong>5 ans</strong>
						 nous vous invitons à découvrir la culture de 
						<strong>5 pays</strong>
						 à travers des zones réparties 
						<strong>dans la ville du Puy en Velay en France</strong>
						.
						<br>
						Sur chaque zone vous serez plongé dans l'univers d'un pays récréé de toute pièce. Vous pourrez principalement y observer une 
						<strong>reconstitution en taille réduite d'un monument.</strong>
					</p>
				</div>
			</div>
		</div>
						...
						<div class="swiper-slide">
							<div class="containerSlide">
								<div class="containerImg">
									<img src="<?php echo $tab_car[$i]['url'];?>" alt="Image du carrousel">
									</img>
								</div>
								<div class="containerBarrePays">
									<div class="containerDrapeauText">
										<div class="drapeauPays">
											<img src="<?php echo $tab_pays[$i]['url'];?>" alt="Drapeau des pays">
											</img>
										</div>
										<div class="textePays">
											<p>
												<strong><?php echo $tab_pays[$i]['nom_pays'];?></strong>
												- 
												<?php echo $tab_pays[$i]['UPPER(pays.nom_monument_principal)'];?>
											</p>
										</div>
									</div>
									<div class="containerBouton">
										<div class="bouton">
											<a href="pays.php?id=<?php echo $tab_pays[$i]['id_pays'] ;?>"><p class="bold">DÉCOUVRIR</p></a>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="containerAlea">
			<div class="alea">
				<div class="textAlea">
					<p>
						SI VOUS <strong>N'ARRIVEZ PAS</strong> À FAIRE <strong>VOTRE CHOIX</strong>
					</p>
				</div>
		...
		<div class="containerOu">
			<div class="ou">
				...
				<div class="ouParagraph">
					<h2>OÙ SE PASSE L'ÉVENEMENT ?</h2>
					<br>
					<p>
						<strong>INTERCULTURAL</strong>
						 se déroule 
						<strong>dans la ville du Puy en Velay</strong>
						 en Auvergne en France. Une ville connué pour sa fabrication de la 
						<strong>dentelle</strong>
						 du Puy, la culture de la 
						<strong>lentille verte</strong>
						 du Puy et la production de 
						<strong>verveine</strong>
						 du Velay. Elle est aussi connue pour être le départ de la 
						<strong>Via Podiensis, un des quatre chemins de Compostelle français.</strong>
					</p>
				</div>
			</div>
		</div>
